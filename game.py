...
class Display:
    ...
    def end(self):
        ...
        self.type.pencolor("black")
        # noinspection PyTypeChecker
        self.type.write(f"SAPPLY AA GAYA  \n", align='center',
...
display = Display()
player = Character([-175, 0], [-175, 0], [0, 0], 15, "images/abhi.gif")
harm1 = Character([-125, 0], [-125, 0], [0, -.2], 25, "images/fire.gif")
harm2 = Character([-75, 0], [-75, 0], [0, .15], 25, "images/fire.gif")
harm3 = Character([-25, 0], [-25, 0], [0, .2], 25, "images/fire.gif")
harm4 = Character([25, 0], [25, 0], [0, .075], 25, "images/fire.gif")
harm5 = Character([75, 0], [75, 0], [0, -.13], 25, "images/fire.gif")
harm6 = Character([125, 0], [125, 0], [0, .1], 25, "images/fire.gif")
door = Character([175, 100], [175, 100], [0, 0], 25, "images/sting.gif")
